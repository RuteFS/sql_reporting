/*
  Healthcare Reporting Project - Create dataset sample
  ---------------------------------------------------
  Creates and loads the tables used to import the original dataset, then limited to 1,000 rows randomly for the project.
